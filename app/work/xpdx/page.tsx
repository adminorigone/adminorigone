...
import { XPDX_CASE, FINAL_CTA, SITE } from "@/constants/site";

export const metadata: Metadata = {
  title: "XPDX Rentals — case study",
  description: XPDX_CASE.intro,
  openGraph: {
    title: "XPDX Rentals — Origo One Case Study",
    description: XPDX_CASE.intro,
    images: [
      {
        url: `/api/og?title=${encodeURIComponent("XPDX Rentals")}&subline=${encodeURIComponent("Origo One Case Study")}`,
        width: 1200,
        height: 630,
        alt: "XPDX Rentals Case Study",
      },
    ],
  },
};
...
export default function XpdxCaseStudy() {
  const c = XPDX_CASE;
